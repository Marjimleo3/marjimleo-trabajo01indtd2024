...
## Criterio de Wald o Pesimista
criterio.Wald(tablaX,favorable=F) 

## Criterio Optimista
criterio.Optimista(tablaX,favorable=F)

## Criterio Hurwicz
criterio.Hurwicz(tablaX,alfa=0.3,favorable=F)

## Savage
criterio.Savage(tablaX,favorable=F)

## Criterio Laplace
criterio.Laplace(tablaX,favorable=F)

## Criterio punto ideal
criterio.PuntoIdeal(tablaX,favorable=F)
